...
class TransformerModel(nn.Module):
    ...
    """
    def __init__(self, vocab_size=50257, d_model=512, n_heads=2, n_blocks=8):
        super().__init__()
...
def main():
    ...
    gds.plot_loss_array(data=transformer_losses, title="Transformer Losses", filename="blocksloss.csv")
