...
class TransformerModel(nn.Module):
    ...
    """
    def __init__(self, vocab_size=50257, d_model=512, n_heads=10, n_blocks=4):
        super().__init__()
...
def main():
    ...
    gds.plot_loss_array(data=transformer_losses, title="Transformer Losses", filename="headsloss.csv")
